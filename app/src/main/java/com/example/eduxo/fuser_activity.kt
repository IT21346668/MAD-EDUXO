...
class fuser_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.user_fetching)

        empRecyclerView = findViewById(R.id.rrrr)
                ...
                if (snapshot.exists()){
                    ...
                    mAdapter.setOnItemClickListener(object : SubjectAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                           ...
                           val intent = Intent(this@fuser_activity , user_Activity::class.java)
